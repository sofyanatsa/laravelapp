...
@section('main')
          ...
          <div class="row" id="rowjs">
            <div class="col-md-6" id="cell-sholat">
              <div id="subuh">
                ...
                <h1><span id="jsubuh" class="label label-default">00:00</span><h1>
              </div>
            </div>
            <div class="col-md-6" id="cell-sholat">
              <div id="terbit">
                <h4><strong>Terbit</strong></h4>
                <h1><span id="jterbit" class="label label-default">00:00</span><h1>
              </div>
            </div>
          </div>
          ...
          <div class="row" id="rowjs">
            <div class="col-md-6" id="cell-sholat">
              <div id="zuhur">
                ...
                <h1><span id="jzuhur" class="label label-default">00:00</span><h1>
              </div>
            </div>
            <div class="col-md-6" id="cell-sholat">
              <div id="asar">
                <h4><strong>Asar</strong></h4>
                <h1><span id="jasar" class="label label-default">00:00</span><h1>
              </div>
            </div>
          </div>
          ...
          <div class="row" id="rowjs">
            <div class="col-md-6" id="cell-sholat">
              <div id="magrib">
                ...
                <h1><span id="jmagrib" class="label label-default">00:00</span><h1>
              </div>
            </div>
            <div class="col-md-6" id="cell-sholat">
              <div id="isya">
                <h4><strong>Isya</strong></h4>
                <h1><span id="jisya" class="label label-default">00:00</span><h1>
              </div>
            </div>
          </div>
  ...
  // Sekarang dalam menit untuk pindah ke praadzan
...
// ==========================================================================
  ...
  $(document).ready(function() {
    ...
    // Jadwal Sholat
    document.getElementById("jsubuh").innerHTML = times.fajr;
    document.getElementById("jterbit").innerHTML = times.sunrise;
    document.getElementById("jzuhur").innerHTML = times.dhuhr;
    document.getElementById("jasar").innerHTML = times.asr;
    document.getElementById("jmagrib").innerHTML = times.maghrib;
    document.getElementById("jisya").innerHTML = times.isha;
